"""add assessment_type manually

Revision ID: b97121abd544
Revises: 
Create Date: 2026-03-02 16:17:51.629373
...
def upgrade():
    ...
    sa.Column('salary_source', sa.String(length=20), nullable=True),
    ...
    sa.ForeignKeyConstraint(['staff_id'], ['employees.id'], name='fk_staff_salaries_employee'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('staff_id', 'month', 'year', name='uq_staff_salary_period')
    )
    ...
    op.create_table('salary_approval_logs',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_table('salary_payment_executions',
    sa.Column('id', sa.Integer(), nullable=False),
...
def downgrade():
    ...
    op.drop_table('bursaries')
    op.drop_table('attendances')
    op.drop_table('teacher_classes')
    op.drop_table('subjects')
    op.drop_table('students')
    op.drop_table('salary_payment_executions')
    op.drop_table('salary_approval_logs')
