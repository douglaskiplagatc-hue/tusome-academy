...
class ClassForm(FlaskForm):
    ...
    level = SelectField('Education Level', choices=[
        ('Primary', 'Primary'),
...
class GradeForm(FlaskForm):
    ...
    assessment = SelectField("Assessment", choices=[("Exam 1","Exam 1"), ("Exam 2","Exam 2"), ("Exam 3","Exam 3"), ("Summative","Summative")], validators=[DataRequired()]),
    year = IntegerField(
        "Year",
...
class FeePaymentForm(FlaskForm):
    ...
    transaction_ref = StringField('Transaction Reference', validators=[Optional()])
